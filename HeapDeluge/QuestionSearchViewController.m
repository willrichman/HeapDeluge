...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (questionToDisplay.answers > 0) {
        cell.answerView.backgroundColor = [UIColor colorWithRed:0 green:0.8 blue:0 alpha:0.6];
    } else {
        cell.answerView.backgroundColor = [UIColor colorWithRed:1 green:0 blue:0 alpha:0.65];
    }
    if (questionToDisplay.score > 0) {
        cell.voteView.backgroundColor = [UIColor colorWithRed:0 green:0.8 blue:0 alpha:0.6];
    } else {
        cell.voteView.backgroundColor = [UIColor colorWithRed:1 green:0 blue:0 alpha:0.65];
    }
